            ...
            setTotalPages(ttlPage)
                ...
                for(let i=0; i< totalIds.length; i++){
                    if(totalIds[i]<=3560){
                        ...
                        let imageName = `#${totalIds[i]} Common`;
